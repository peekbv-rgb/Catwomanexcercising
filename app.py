...
with render_tab:
    ...
    st.info(
        ...
        "Kling klaar is. Nieuwe tunnel-hostnamen krijgen nu automatisch extra DNS-warm-up/retries."
    )
    ...
    st.markdown(
        "**Pipeline:** refs controleren → tijdelijke HTTPS motion-URL → DNS-warm-up → Kling Motion Control → "
